// To parse this data:
//
//   import { Convert, WpCategory } from "./file";
//
//   const wpCategory = Convert.toWpCategory(json);
//
...
export class Convert {
  public static toWpCategory(json: string): WpCategory {
      return cast(JSON.parse(json), r("WpCategory"));
  }

  public static wpCategoryToJson(value: WpCategory): string {
      return JSON.stringify(uncast(value, r("WpCategory")), null, 2);
  }
}
