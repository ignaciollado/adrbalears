// To parse this data:
//
//   import { Convert, WpPosts } from "./file";
//
//   const wpPosts = Convert.toWpPosts(json);
//
...
export class Convert {
  public static toWpPosts(json: string): WpPost {
      return cast(JSON.parse(json), r("WpPost"));
  }

  public static wpPostsToJson(value: WpPost): string {
...
const typeMap: any = {
  ...
  "Links": o([
      ...
      { json: "wp:featuredmedia", js: "wp:featuredmedia", typ: a(r("Author")) },
